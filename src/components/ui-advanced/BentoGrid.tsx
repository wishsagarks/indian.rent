    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-6">
           <motion.div variants={iconVariants} className="w-16 h-16 rounded-lg skeuo-raised flex items-center justify-center shadow-lg shadow-secondary/20 border border-secondary/20">
      ...
      >
        <div className="flex items-center gap-4">
           <motion.div variants={iconVariants} className="w-12 h-12 rounded-lg skeuo-raised flex items-center justify-center border border-white/10">
