/*
  Fix get_platform_stats() RPC to return monthly velocity and area distribution

  Issue: Migration 20260520100300 uses CREATE instead of CREATE OR REPLACE,
  so the old simple version from 20260517 is still in use.

  This migration drops the old version and creates the extended version
  that returns monthlyVelocity and areaDistribution for the analytics dashboard.
*/
